...
<body>
<div class="title" style="margin:0 auto; width:400px; height:30px; line-height:30px; background-color:#CCC;padding-left:10px; ">文件上传</div>
<div class="box">
<form action="admin.php?m=upfile&" method="post" enctype="multipart/form-data">
