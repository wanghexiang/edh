...
switch($a)
{
	...
	case 'add_db':
		...
		if($shopid)
		{
			$db->query("UPDATE ".table('shop')." SET endtime=".time().",catid='$catid',smid='$smid',amid='$amid',shopname='$shopname',provinceid='$provinceid',cityid='$cityid',townid='$townid',address='$address',qq='$qq',phone='$phone',shopno='$shopno',info='$info',addpic='$addpic' WHERE shopid='$shopid' ");
			//更新过度版
		...
		{
			$db->query("INSERT INTO ".table('shop')." SET starttime=".time().",catid='$catid',smid='$smid',amid='$amid',shopname='$shopname',provinceid='$provinceid',cityid='$cityid',townid='$townid',address='$address',qq='$qq',phone='$phone',shopno='$shopno',info='$info',addpic='$addpic',siteid='$siteid' ");
