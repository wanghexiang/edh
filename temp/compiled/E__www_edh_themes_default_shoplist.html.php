...
<div class="kuan clear col pb10">当前地区:[<?php echo $this->_var['town']; ?>]<a href="index.php" class="c" style="color:gray">切换地址</a></div>
<div class="kuan mt5"><img src="image/banner.jpg" /></div>
<dl class="cang kuan">
	<dt>收藏店铺</dt>
	 <?php $_from = $this->_var['fav']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'f');if (count($_from)):
    foreach ($_from AS $this->_var['f']):
?>
		<?php if ($this->_var['f']['logo']): ?><dd><a href="index.php?m=shop&shopid=<?php echo $this->_var['f']['shopid']; ?>"><img style="position:absolute;width:120px;height:70px;border:none;margin:10px;" src="<?php echo $this->_var['f']['logo']; ?>"/></a></dd> <?php endif; ?>
...
?>
  ...
  <dl class="cang kuan">
	<dt>推荐店铺</dt>
    <?php $_from = $this->_var['recommend']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'r');if (count($_from)):
    foreach ($_from AS $this->_var['r']):
?>
		<?php if ($this->_var['r']['logo']): ?><dd><a href="index.php?m=shop&shopid=<?php echo $this->_var['r']['shopid']; ?>"><img style="position:absolute;width:120px;height:70px;border:none;margin:10px;" src="<?php echo $this->_var['r']['logo']; ?>"/></a></dd> <?php endif; ?>
	 <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  	<dt class="bd"><h1 class="fb"><a href="#"></a></h1></dt>
</dl>
<br/>
