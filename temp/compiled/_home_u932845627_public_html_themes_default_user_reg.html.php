...
-->
    <input style="background: url(/image/signInSprite.png) no-repeat 0 -298px; width:85px;height:35px;"  type="submit" value="注册"/>
     
 </form>
 </div>
 <div class="signInbox p10 left ml30">

     <p class="f12 pb10 bbd mb10 tc color06c lh30">已经注册过了？<a href="#"  class="loginBtn ml10">请登录</a></p>
 </div>
 <div class="clear"></div>
</div>
