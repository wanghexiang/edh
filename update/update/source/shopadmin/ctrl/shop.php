...
}elseif($a=='add_db')
{
	...
	if($shopid)
	{
		$db->query("UPDATE ".table('shop')." SET shopname='$shopname',catid='$catid',smid='$smid',amid='$amid',provinceid='$provinceid',cityid='$cityid',townid='$townid',address='$address',qq='$qq',phone='$phone',shopno='$shopno',info='$info',logo='$logo' WHERE shopid='$shopid' ");
		//更新过度版
